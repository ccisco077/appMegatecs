...
import com.example.appmegatecs.databinding.ActivityNavigationHomeBinding;
...
public class NavigationHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_categorys , R.id.nav_products, R.id.nav_shoppingCart, R.id.nav_profile)
